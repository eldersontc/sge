 ...
 * @author elderson
 */
public class lisDistrito extends frameBasex<Distrito> {

    /**
     * Creates new form lisDistrito
     */
    public lisDistrito(int modo) {
        initComponents();
        Init(modo, "");
    }

    public lisDistrito(int modo, String filtro) {
        initComponents();
        Init(modo, filtro);
    }
    ...
    public class swObtenerDistritos extends SwingWorker<Object, Object> {
        ...
        protected Object doInBackground() throws Exception {
            ...
            String json = "";
            try {
                json = cliente.ObtenerDistritos(new Gson().toJson(filtro));
            } catch (Exception e) {
        ...
        protected void done() {
            try {
                ...
                if (resultado[0].equals("true")) {
                    ...
                    AgregarOrdenamiento(tbDistritos);
                }
                OcultarCargando(frame);
            } catch (Exception e) {
                OcultarCargando(frame);
    ...
    public Distrito getSeleccionado() {
        return seleccionado;
    }
    ...
    private void initComponents() {
        ...
        tbDistritos = new javax.swing.JTable();
        ...
        tbDistritos.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        if (tbDistritos.getColumnModel().getColumnCount() > 0) {
            ...
            tbDistritos.getColumnModel().getColumn(2).setPreferredWidth(200);
            tbDistritos.getColumnModel().getColumn(3).setPreferredWidth(20);
            tbDistritos.getColumnModel().getColumn(4).setPreferredWidth(20);
        }
        ...
        lblTitulo.setText("LISTADO DE DISTRITOS");
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        ...
        //AgregarFila(tbDistritos, new Object[]{false, 0, "", "", false, Icon_Save, Icon_Dele});
    ...
    private void txtFiltroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtFiltroActionPerformed
        // TODO add your handling code here:
        Filtrar(tbDistritos, txtFiltro.getText());
    ...
    private javax.swing.JTable tbDistritos;
