 ...
 * @author elderson
 */
public class lisDepartamento extends frameBase<Departamento> {
    ...
    Action save = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            //new swGuardarDepartamento().execute();
        }
    };
    ...
    public class swObtenerDepartamentos extends SwingWorker<Object, Object> {
    ...
    private void initComponents() {
        ...
        if (tbDepartamentos.getColumnModel().getColumnCount() > 0) {
            ...
            tbDepartamentos.getColumnModel().getColumn(2).setPreferredWidth(200);
            tbDepartamentos.getColumnModel().getColumn(3).setPreferredWidth(20);
            tbDepartamentos.getColumnModel().getColumn(4).setPreferredWidth(20);
        }
        ...
        lblTitulo.setText("LISTADO DE DEPARTAMENTOS");
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        ...
        //AgregarFila(tbDepartamentos, new Object[]{false, 0, "", "", false, Icon_Save, Icon_Dele});
    ...
    private void txtFiltroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtFiltroActionPerformed
        // TODO add your handling code here:
        Filtrar(tbDepartamentos, txtFiltro.getText());
