...
public class ApplicationConfig extends Application {
    ...
    private void addRestResourceClasses(Set<Class<?>> resources) {
        ...
        resources.add(com.sge.modulos.administracion.servicios.FiltroSRV.class);
        resources.add(com.sge.modulos.administracion.servicios.MensajeSRV.class);
        ...
        resources.add(com.sge.modulos.administracion.servicios.PerfilSRV.class);
        ...
        resources.add(com.sge.modulos.facturacion.servicios.GuiaRemisionSRV.class);
        ...
        resources.add(com.sge.modulos.produccion.servicios.OrdenProduccionSRV.class);
