...
public class ItemPlantillaSolicitudCotizacionDAO extends BaseDAO {
    ...
    public int ActualizarItemPlantillaSolicitudCotizacion(ItemPlantillaSolicitudCotizacion item) {
        String sql = String.format("UPDATE Ventas.ItemPlantillaSolicitudCotizacion SET nombre = '%s', idServicioImpresion = %d, "
                + "nombreServicioImpresion = '%s', idMaterial = %d, nombreMaterial = '%s', altoMaterial = %s, largoMaterial = %s, idUnidadMaterial = %d, abreviacionUnidadMaterial = '%s', nombreTipoUnidad = '%s', "
                ...
                item.getNombreMaterial(), item.getAltoMaterial(), item.getLargoMaterial(), item.getIdUnidadMaterial(), item.getAbreviacionUnidadMaterial(), item.getNombreTipoUnidad(), item.getUnidadMedidaAbierta(), item.isMedidaAbierta(),
