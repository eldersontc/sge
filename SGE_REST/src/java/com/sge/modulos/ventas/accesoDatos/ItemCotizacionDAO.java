...
public class ItemCotizacionDAO extends BaseDAO {
    ...
    public int ActualizarItemCotizacion(ItemCotizacion item) {
        String sql = String.format("UPDATE Ventas.ItemCotizacion SET nombre = '%s', idServicioImpresion = %d, "
                ...
                + "cantidadDemasiaMaterial = %d, cantidadProduccion = %d, cantidad = %d, cantidadPaginasSobrantes = %d, "
                ...
                item.getNombreMaterial(), item.getAltoMaterial(), item.getLargoMaterial(), item.getIdUnidadMaterial(), 
                ...
                item.getCantidadPaginasSobrantes(), item.isIncluirEnPresupuesto(), item.isVerPrecioEnPresupuesto(), item.getTotalMaquina(), item.getTotalMaterial(),
