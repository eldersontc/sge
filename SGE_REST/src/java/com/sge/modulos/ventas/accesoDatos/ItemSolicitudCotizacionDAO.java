...
public class ItemSolicitudCotizacionDAO extends BaseDAO {
    ...
    public int ActualizarItemSolicitudCotizacion(ItemSolicitudCotizacion item) {
        String sql = String.format("UPDATE Ventas.ItemSolicitudCotizacion SET nombre = '%s', idServicioImpresion = %d, "
                ...
                + "altoMaximoPliegoMaquina = %d, idMaterial = %d, codigoMaterial = '%s', nombreMaterial = '%s', largoMaterial = %s, altoMaterial = %s, "
                + "idUnidadMaterial = %d, abreviacionUnidadMaterial = '%s', factorUnidadMaterial = %d, nombreTipoUnidad = '%s', "
                ...
                item.getCodigoMaterial(), item.getNombreMaterial(), item.getLargoMaterial(), item.getAltoMaterial(), item.getIdUnidadMaterial(),
