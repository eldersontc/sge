...
public class ItemSolicitudCotizacionDAO extends BaseDAO {
    ...
    public int ActualizarItemSolicitudCotizacion(ItemSolicitudCotizacion item) {
        String sql = String.format("UPDATE Ventas.ItemSolicitudCotizacion SET nombre = '%s', idServicioImpresion = %d, "
                ...
                + "altoMaximoPliegoMaquina = %d, idMaterial = %d, nombreMaterial = '%s', largoMaterial = %s, altoMaterial = %s, idUnidadMaterial = %d, abreviacionUnidadMaterial = '%s', nombreTipoUnidad = '%s', "
                ...
                item.getNombreMaterial(), item.getLargoMaterial(), item.getAltoMaterial(), item.getIdUnidadMaterial(), item.getAbreviacionUnidadMaterial(), item.getNombreTipoUnidad(), item.getUnidadMedidaAbierta(), item.isMedidaAbierta(),
